...
public class ClassroomController extends BaseController {
	...
	@ResponseBody
	public SystemPage<Classroom> getClassroomPage(Integer pageNum, Integer pageSize, Integer draw) throws Exception {
		// 封装分页对象
		SystemPage<Classroom> systemPage = new SystemPage<Classroom>(pageNum, pageSize, draw);
		...
		// 通过dubbo进行远程调用，分页查询
		systemPage = classroomTransport.getClassroomPage(systemPage);
		return systemPage;
	}
}
